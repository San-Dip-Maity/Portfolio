...
export const PROJECTS = [
  {
    ...
    image: project1,
    description:
      "A job portal website that connects job seekers with employers, featuring job search, application tracking, and user profiles.",
    technologies: ["React","Tailwind CSS", "ExpressJs", "Node.js", "MongoDB"],
  },
  {
  ...
  },
  {
    ...
    image: project4,
    description:
      "A web application that provides information about countries, including population, languages, and currencies.",
...
export const CONTACT = {
  ...
  phoneNo: "+91 79087297570 ",
  email: "sandipmaity21052003@gmail.com",
};
